...
Keep finding real cause and keep optimizing until you get desire targets. Once target achieved then generate updated code with clear explanations of changes.
